...
import { Map, ArrowRight, UserCheck, Microscope, Compass, Library, BookOpen, Send, Sparkles } from 'lucide-react';
...
export const museumDirectory = [
  {
    code: "HALL 00",
    title: "Entrance Hall",
    subtitle: "Identity, core mission, availability, and professional credentials terminal.",
    anchor: "hero",
    icon: UserCheck,
  ...
  },
  {
    ...
    subtitle: "Constructed systems, interactive engineering products, and live deployment cards.",
    anchor: "projects",
    icon: Microscope,
  ...
  },
  {
    ...
    subtitle: "Real-time systems instrumentation, tactical tech inventories, and stack benchmarks.",
    anchor: "forge",
    icon: Sparkles,
  ...
  },
  {
    ...
    subtitle: "Autonomous sandboxes exploring Gemini agent interaction models, AI play, and Web3 nodes.",
    anchor: "experiments",
    icon: Compass,
  ...
  },
  {
    ...
    subtitle: "Systems reasoning applied to physical space, game states (chess), watering hardware, and memory timelines.",
    anchor: "archives",
    icon: Library,
  ...
  },
  {
    ...
    subtitle: "Essays, modular documentation, architecture concepts, and live cognitive stream logs.",
    anchor: "garden",
    icon: BookOpen,
  ...
  },
  {
    code: "HALL 06",
    title: "Signal Room",
    subtitle: "Bi-directional contact portals, active site telemetry logs, and collaborative hooks.",
    anchor: "signal",
    icon: Send,
  ...
  return (
    <div id="directory" className="scroll-mt-32 col-span-12 my-8 p-1">
      ...
      >
        ...
        <div id="directory-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 relative z-10">
