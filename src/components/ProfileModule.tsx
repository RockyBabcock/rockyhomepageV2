    ...
    <div className="flex flex-col gap-12" ref={containerRef}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto mt-12">
          ...
          >
             <a href="https://github.com/RockyBabcock" target="_blank" rel="noopener noreferrer" className="text-ink hover:text-primary transition-colors flex items-center gap-2 font-mono text-xs uppercase font-black tracking-widest group">
