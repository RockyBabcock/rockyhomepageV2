    ...
    <div className="min-h-screen w-full relative flex flex-col items-center justify-center bg-gradient-to-b from-[#020202] to-[#1E152A] overflow-hidden border-b-4 border-[#C0C0C0]">
      ...
      >
         ...
         <div className="absolute inset-0 pointer-events-none opacity-20 flex items-center justify-center">
            <svg viewBox="0 0 100 100" className="w-full h-[60%] max-w-2xl stroke-[#C0C0C0] fill-none stroke-[0.2]">
               <motion.path d="M 10 90 Q 50 10 90 90" animate={{ d: ["M 10 90 Q 50 10 90 90", "M 20 90 Q 50 20 80 90", "M 10 90 Q 50 10 90 90"] }} transition={{ duration: 10, repeat: Infinity }} />
               <motion.path d="M 30 90 Q 50 40 70 90" animate={{ d: ["M 30 90 Q 50 40 70 90", "M 40 90 Q 50 50 60 90", "M 30 90 Q 50 40 70 90"] }} transition={{ duration: 8, repeat: Infinity }} />
         ...
         <div className="relative w-48 h-64 border-2 border-[#C0C0C0] flex items-center justify-center mb-8 bg-[#0a0a0a] shadow-[0_0_30px_rgba(0,119,255,0.2),8px_8px_0_#8A1538] group overflow-hidden">
             ...
             <div className="absolute inset-0 overflow-hidden">
                {Array.from({length: 10}).map((_,i) => (
                  <motion.div key={i} className="absolute w-px h-8 bg-[#C0C0C0]/50" style={{ left: `${10 * i}%` }} animate={{ y: [-50, 300], opacity: [0, 1, 0] }} transition={{ duration: 2 + Math.random(), repeat: Infinity, delay: Math.random() }} />
                ))}
             </div>
             {/* Structure */}
             ...
             <motion.div className="absolute top-[20%] w-[120%] h-1 bg-[#C0C0C0] z-10" animate={{ width: ["100%", "130%", "100%"] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} />
         ...
         <div className="text-center bg-black/80 px-4 py-8 md:p-8 border-4 border-[#C0C0C0] shadow-[12px_12px_0_rgba(0,0,0,1)] relative max-w-2xl w-full">
            <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-4 text-white">
              Some are born to build.<br/>
              Some are born to become<br/>
              the foundation.
            </h1>
         ...
         <motion.div 
          ...
          >
            <span className="font-mono text-[10px] uppercase tracking-widest text-white/50 bg-[#4C392D] px-2 border border-white/20">Step Forward</span>
...
function TheBodyAsStructure({ soundEnabled }: { soundEnabled: boolean }) {
  ...
  const currentCopy = activeElement ? copyData[activeElement as keyof typeof copyData] : null;
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-12 left-8 md:top-24 md:left-24 z-20 pointer-events-none">
        <h2 className="text-[10px] md:text-xs font-mono uppercase tracking-[0.3em] text-[#C0C0C0]/50 mb-2">Hall 1</h2>
        <h3 className="text-2xl md:text-4xl font-headline font-black text-white tracking-widest uppercase">The Body As Structure</h3>
      </div>
      ...
      >
        ...
        >
          ...
          <motion.div 
            ...
            style={{ width: activeElement === 'weight' ? 6 : activeElement === 'height' ? (freezeFrame ? 4 : 2) : 1 }}
            animate={
              activeElement === 'height' 
                ? (freezeFrame ? { scaleY: 1, y: 0 } : { scaleY: [1, 1.2, 0.8, 1], y: [0, -50, 10, 0] })
                : activeElement === 'weight'
                ? (freezeFrame ? { scaleY: 0.9 } : { scaleX: [1, 3, 1], scaleY: [1, 0.9, 1] })
                : { scaleY: 1, y: 0 }
            }
            transition={activeElement === 'height' && !freezeFrame ? { duration: 0.8, times: [0, 0.3, 0.7, 1] } : activeElement === 'weight' && !freezeFrame ? { duration: 0.5, repeat: 1, repeatType: "reverse" } : { duration: 2, repeat: Infinity, repeatType: "mirror", ease: "easeInOut" }}
            onClick={() => { setActiveElement('height'); setFreezeFrame(false); if(soundEnabled) playAudio('swoosh', true); }}
          >
          ...
          {/* Wingspan Arcs */}
          {(!activeElement || activeElement === 'wingspan' || activeElement === 'weight' || activeElement === 'origin') && (
            <motion.div 
              className="absolute top-1/4 border-t border-[#C0C0C0] rounded-t-full cursor-pointer transition-all mix-blend-screen"
              style={{ originY: 1, borderTopWidth: activeElement === 'weight' ? 3 : 1 }}
              initial={{ width: "30%", height: "15%", opacity: 0.5 }}
              animate={
                activeElement === 'wingspan' 
                  ? (freezeFrame ? { width: "80%", height: "25%", opacity: 1 } : { width: ["30%", "90%", "80%"], height: ["15%", "30%", "25%"], opacity: [0.5, 1, 1] }) 
                  : { width: "30%", height: "15%", opacity: 0.5 }
              }
              transition={activeElement === 'wingspan' && !freezeFrame ? { duration: 1, ease: "easeOut" } : { duration: 0.5 }}
              onClick={() => { setActiveElement('wingspan'); setFreezeFrame(false); if(soundEnabled) playAudio('swoosh', true); }}
            />
          )}
          ...
          <motion.div 
            ...
            style={{ backgroundColor: activeElement === 'origin' ? '#ffffff' : '#404040' }}
            animate={
              activeElement === 'origin'
                ? (freezeFrame ? { scale: 3, opacity: 0.8, boxShadow: "0 0 40px #fff" } : { scale: [1, 5, 3], opacity: [0.5, 1, 0.8], boxShadow: ["0 0 0 #fff", "0 0 60px #fff", "0 0 40px #fff"] })
                : { scale: [1, 1.2, 1], opacity: [0.3, 0.6, 0.3], boxShadow: "0 0 10px rgba(192,192,192,0.2)" }
            }
            transition={activeElement === 'origin' && !freezeFrame ? { duration: 1, ease: "easeOut" } : { duration: 4, repeat: Infinity, ease: "easeInOut" }}
            onClick={() => { setActiveElement('origin'); setFreezeFrame(false); if(soundEnabled) playAudio('beep', true); }}
          >
          ...
          <div className="absolute inset-0 w-full h-full flex flex-col justify-around items-center pointer-events-none">
            <div className="w-1/2 h-1/4 pointer-events-auto cursor-pointer" onClick={() => { setActiveElement('wingspan'); setFreezeFrame(false); }} />
            <div className="w-1/4 h-1/2 pointer-events-auto cursor-pointer" onClick={() => { setActiveElement('height'); setFreezeFrame(false); }} />
            <div className="w-1/2 h-1/4 pointer-events-auto cursor-pointer" onClick={() => { setActiveElement('origin'); setFreezeFrame(false); }} />
          </div>
        </motion.div>
      </motion.div>
      ...
      <div className="absolute right-4 md:right-8 top-1/4 md:top-1/3 flex flex-col gap-6 md:gap-8 z-30 opacity-70 hover:opacity-100 transition-opacity mt-20 md:mt-0">
        {Object.entries(copyData).map(([key, data]) => (
          <div 
            ...
            onClick={() => { setActiveElement(key); setFreezeFrame(false); if(soundEnabled) playAudio('beep', true); }}
          >
            <div className={`w-[6px] h-[6px] rounded-full transition-colors ${activeElement === key ? 'bg-[#FF7B00] shadow-[0_0_10px_#FF7B00]' : 'bg-transparent border border-[#C0C0C0]/50'}`} />
        ...
        {!activeElement ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <h3 className="font-serif italic text-lg md:text-2xl text-[#E4DCCF] mb-4 leading-relaxed mix-blend-screen drop-shadow-[0_0_15px_rgba(212,175,55,0.2)]">
              His body is a draft,<br/>
              Every jump is a revision,<br/>
            ...
            <p className="font-mono text-[10px] md:text-xs text-[#C0C0C0]/60 leading-relaxed max-w-xl mx-auto border-t border-[#C0C0C0]/20 pt-4 mt-2">
              Wembanyama’s body is not a moving machine but a living structural system.
              He made me rethink interfaces: How do we design digital architecture that is both extremely tall and yet elegant, broad yet not oppressive, light yet able to withstand impact?
              In this hall, height is just the starting point, and posture is the design.
            </p>
          </motion.div>
        ) : (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} key={activeElement}>
      ...
      >
        <span className="block font-mono text-[9px] uppercase tracking-widest text-[#C0C0C0]/50 mb-2">From Court to Canvas</span>
        <p className="font-mono text-[9px] md:text-[10px] uppercase leading-relaxed text-[#C0C0C0]/70">
          The vertical hierarchy, structural tension, and breathing space that I pursue in the design system can all be found here.
        </p>
      </motion.div>
...
function TheFiveAndTheOne({ soundEnabled }: { soundEnabled: boolean }) {
  ...
  const players = [
    { id: 'pg', role: 'Point Guard', keyword: 'Rhythm.', desc: 'Not directing, but listening to the breathing of the entire stadium.', sysDesc: 'A system’s heartbeat requires observation before execution.', photo: 'https://images.unsplash.com/photo-1546519638-68e109498bdc?auto=format&fit=crop&q=80&w=400' },
    { id: 'sg', role: 'Shooting Guard', keyword: 'Space.', desc: 'It is not about possessing, but about creating possibilities for others.', sysDesc: 'Negative space is an active design element, not just emptiness.', photo: 'https://images.unsplash.com/photo-1504450758481-7338eba7524a?auto=format&fit=crop&q=80&w=400' },
    { id: 'c', role: 'Center — Victor Wembanyama', keyword: 'Presence.', desc: 'Not to rule, but to make all structures possible.', sysDesc: 'A strong core framework does not dominate the system. It allows every supporting element to perform with more clarity.', isCenter: true, photo: 'https://images.unsplash.com/photo-1519861531473-9200262188bf?auto=format&fit=crop&q=80&w=600' },
    { id: 'sf', role: 'Small Forward', keyword: 'Tear.', desc: 'It is not about destroying, but opening up new channels.', sysDesc: 'Disruption is required to prevent a system from becoming stagnant.', photo: 'https://images.unsplash.com/photo-1548083884-6338bf3e7bce?auto=format&fit=crop&q=80&w=400' },
    { id: 'pf', role: 'Power Forward', keyword: 'Confrontation.', desc: 'Not to block, but to withstand and transform the impact.', sysDesc: 'Error states and edge cases are moments of transformation, not failure.', photo: 'https://images.unsplash.com/photo-1580087433295-ab2600c1030e?auto=format&fit=crop&q=80&w=400' },
  ];
  ...
  return (
    <div className="min-h-screen w-full relative flex flex-col items-center p-8 lg:p-24 border-b-4 border-[#C0C0C0] bg-[#020202] overflow-hidden font-sans">
       ...
       {/* Stadium Watermark */}
       <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1505666287802-931dc83948e9?auto=format&fit=crop&w=1200')] bg-cover bg-center mix-blend-screen pointer-events-none transition-opacity duration-1000" style={{ opacity: hoveredNode ? 0.12 : 0.08 }} />

       <div className="absolute top-12 left-8 md:top-24 md:left-24 z-20 pointer-events-none">
        <h2 className="text-[10px] md:text-xs font-mono uppercase tracking-[0.3em] text-[#C0C0C0]/50 mb-2">Hall 2</h2>
        <h3 className="text-2xl md:text-4xl font-headline font-black text-white tracking-widest uppercase">The Five and the One</h3>
      </div>
       ...
       <div className="w-full max-w-6xl flex-grow flex flex-col items-center justify-center relative mt-24 z-10 min-h-[500px]">
          ...
          <div className="relative w-full h-full min-h-[60vh] flex flex-col md:flex-row items-center justify-center md:items-stretch md:justify-around gap-4 md:gap-0 mt-8 mb-8">
             ...
             <motion.div 
               ...
               animate={{ 
                 boxShadow: hoveredNode === 'c' ? '0 -15px 40px rgba(212,175,55,0.3)' : 'none',
             ...
             {players.map((p, idx) => {
               ...
               return (
                 <motion.div 
                   ...
                   onHoverStart={() => { setHoveredNode(p.id); if(soundEnabled) playAudio('beep', true); }}
                   onHoverEnd={() => setHoveredNode(null)}
                   onClick={() => { setActiveNode(isActive ? null : p.id); if(soundEnabled) playAudio('door', true); }}
                 >
                    {/* The structural Line on Desktop */}
                    <motion.div 
                      className={`relative flex-grow ${
                        p.isCenter ? 'w-6 md:w-8 bg-gradient-to-b from-[#8A1538] to-[#C0C0C0]' : 
                        idx === 0 ? 'w-3 md:w-4 bg-[#0077FF]/50' :
                        idx === 1 ? 'w-3 md:w-4 bg-[#3F2B56]/60' :
                        idx === 3 ? 'w-3 md:w-4 bg-[#F3ECE1]/80' :
                        'w-3 md:w-4 bg-[#D15600]/60'
                      } hidden md:flex flex-col items-center justify-start border-x border-[#C0C0C0]/10`}
                      style={{ height: p.isCenter ? '100%' : '80%', marginTop: p.isCenter ? '0' : 'auto' }}
                      animate={{
                        filter: isHovered || p.isCenter ? 'brightness(1.2)' : 'brightness(0.5)'
                      }}
                    >
                       {/* Light Arc / Connection to center */}
                       {!p.isCenter && (hoveredNode === p.id || hoveredNode === 'c') && (
                          <motion.svg 
                            className="absolute top-[30%] pointer-events-none z-0"
                            style={{ 
                              width: `${Math.abs(posOffset) * 150}px`, height: '100px', 
                              left: posOffset < 0 ? '50%' : 'auto', right: posOffset > 0 ? '50%' : 'auto',
                          ...
                          >
                             <path d={`M 0,50 Q ${Math.abs(posOffset) * 75},-20 ${Math.abs(posOffset) * 150},20`} fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="1" strokeDasharray="4 4" />
                          </motion.svg>
                       )}
                       ...
                       <motion.div 
                         ...
                         style={{ 
                            ...
                            opacity: p.isCenter ? (hoveredNode === 'c' ? 1 : 0.9) : (isHovered ? 1 : 0.4),
                            filter: isHovered || (p.isCenter && centerHovered) ? 'grayscale(100%) contrast(1.5) brightness(1.2)' : 'grayscale(100%) blur(1px) contrast(1.2)',
                            boxShadow: isHovered || (p.isCenter && centerHovered) ? '0 0 30px rgba(0,0,0,0.8)' : 'none'
                         }}
                       >
                         ...
                         <div className="w-full h-full p-1 relative border border-[#C0C0C0]/20 bg-[url('https://www.transparenttextures.com/patterns/rice-paper-2.png')] bg-blend-overlay">
                            ...
                            <img src={p.photo} alt={p.role} className="w-full h-full object-cover mix-blend-screen opacity-80" />
                         </div>
                       </motion.div>
                    </motion.div>
                    ...
                    <div className="md:hidden w-full border border-[#C0C0C0]/30 mb-2 relative flex items-center p-3 bg-[#4C392D]">
                       <img src={p.photo} alt="" className="w-16 h-16 object-cover grayscale opacity-50 mr-4 border border-[#C0C0C0]/20" />
                       <div className="flex-grow">
                         <div className="text-[9px] uppercase font-mono text-[#d4af37] mb-1">{p.role}</div>
                         <div className="text-sm font-bold text-white uppercase tracking-widest">{p.keyword}</div>
                       </div>
                    </div>

                    <div className={`mt-4 font-mono text-[9px] uppercase tracking-widest bg-[#4C392D] p-2 border border-[#C0C0C0]/20 ${isHovered ? 'text-white border-white/50' : 'text-[#C0C0C0]/50'} hidden md:block transition-colors shrink-0`}>
              ...
              >
                 ...
                 <div className="w-full max-w-3xl bg-[#0a0a0a] border border-[#C0C0C0] shadow-[12px_12px_0_rgba(192,192,192,0.2)] pointer-events-auto flex flex-col md:flex-row relative z-10 overflow-hidden">
                    ...
                    <div className="w-full md:w-2/5 h-64 md:h-auto overflow-hidden relative">
                       ...
                       <img src={players.find(p => p.id === activeNode)?.photo} className="w-full h-full object-cover grayscale contrast-[1.5] brightness-90 relative z-0" alt="" />
                    </div>
                    ...
                    <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center relative bg-[#020202]">
                       ...
                       <h4 className="font-mono text-[10px] md:text-xs uppercase tracking-widest text-[#d4af37] mb-2">{players.find(p => p.id === activeNode)?.role}</h4>
                       <h3 className="text-3xl md:text-5xl font-black text-[#E4DCCF] uppercase mb-6 tracking-tighter">{players.find(p => p.id === activeNode)?.keyword}</h3>
                       ...
                       <div className="pt-6 border-t border-[#C0C0C0]/20 mt-auto">
                         <span className="block text-[9px] font-mono text-white/50 uppercase mb-2 tracking-widest">System Interpretation</span>
       ...
       <div className="w-full max-w-5xl mt-24 md:mt-32 flex flex-col md:flex-row items-center border-t border-[#C0C0C0]/20 pt-16 mb-16 gap-12 relative z-10 bg-black/50 p-8">
          <div className="w-full md:w-1/2">
             <div className="aspect-[4/3] bg-[#050505] border-[6px] border-[#111] overflow-hidden grayscale contrast-[1.2] relative">
               ...
               <img src="https://images.unsplash.com/photo-1518063319789-7217e6706b04?auto=format&fit=crop&w=800" alt="Reflection" className="w-full h-full object-cover opacity-60" />
             </div>
          </div>
          <div className="w-full md:w-1/2 md:pl-8">
             <h4 className="font-mono text-[10px] uppercase tracking-widest text-white/60 mb-6 border-l-2 border-[#d4af37] pl-4">Reflection</h4>
             <p className="font-serif italic text-2xl md:text-3xl text-[#E4DCCF] leading-relaxed mb-8 drop-shadow-[0_0_10px_rgba(212,175,55,0.2)]">
               What I admire most about Wemby is not his size, but how he makes the people around him better.
             </p>
             <div className="font-mono text-xs text-[#C0C0C0]/80 leading-relaxed uppercase bg-[#111] p-6 border border-[#C0C0C0]/20 shadow-[6px_6px_0_rgba(192,192,192,0.1)]">
               This is the essence of a good design system:<br/><br/>
               The core framework is strong enough, but always provides room for other elements to grow.
             </div>
          </div>
       </div>
       ...
       <div className="text-center bg-[#050505] border border-[#d4af37]/30 p-8 md:p-12 max-w-4xl w-full relative z-10 mb-8 mt-8">
          <h4 className="font-mono text-[10px] md:text-xs uppercase tracking-widest text-[#d4af37] mb-6">From Team Structure to Design Systems</h4>
          <p className="font-headline text-lg md:text-xl text-[#E4DCCF] leading-relaxed uppercase max-w-2xl mx-auto font-medium">
            What basketball teaches me about design is that strong systems are not rigid. They are clear, supportive, and spacious enough to let each element perform at its highest level.
          </p>
       </div>
...
function ThePhysicsOfMotion({ soundEnabled }: { soundEnabled: boolean }) {
  ...
  const moves = [
    { title: "Shot Block", metaphor: "Interruption is another continuation.", desc: "Interruption is a continuation. Like stopping a wave before it hits, but still allowing it to flow around.", date: "2025.03.12 vs Lakers · Section 3 8:47" },
    { title: "Three-Pointer", metaphor: "Trust in the trajectory. Every shot has a rhythm.", desc: "The path of the ball creates a clean, elegant arc as the tension builds before the release.", date: "2024.11.08 vs Knicks · Section 1 4:12" },
    { title: "Dribble", metaphor: "Direction is more important than speed.", desc: "This represents direction change under pressure, more important than speed.", date: "2025.01.22 vs Nuggets · Section 4 2:05" },
    { title: "Alley-Oop", metaphor: "The tacit understanding is a preset accident.", desc: "Tacit understanding is a preset accident — you don't control it; you allow it to happen.", date: "2025.02.14 vs Mavericks · Section 2 6:30" },
  ];
    ...
    <div className="min-h-screen w-full relative flex flex-col border-b-4 border-[#C0C0C0] bg-[#020202] font-sans">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-8 z-0 opacity-[0.05] pointer-events-none text-center">
        <h2 className="text-4xl md:text-8xl font-black uppercase leading-tight tracking-tighter">
          The body is architecture<br/>and movement is mechanics.<br/>
          Every move is a<br/>Brutalist poem.
        </h2>
      </div>

      <div className="absolute top-12 left-8 md:top-24 md:left-24 z-20 pointer-events-none">
        <h2 className="text-[10px] md:text-xs font-mono uppercase tracking-[0.3em] text-[#C0C0C0]/50 mb-2">Hall 3</h2>
        <h3 className="text-2xl md:text-4xl font-headline font-black text-white tracking-widest uppercase">The Physics of Motion</h3>
      </div>
                 ...
                 {activeMove === 0 && (
                  <div className="relative w-full max-w-sm h-64 flex items-center justify-center">
                    <motion.div 
                      ...
                      transition={{ duration: 2.5, times: [0, 0.15, 0.8, 1], repeat: Infinity, repeatDelay: 1.5, ease: "easeOut" }}
                    />
                    <motion.div 
                      className="absolute w-full h-1 bg-[#C0C0C0] origin-left top-[30%]"
                      initial={{ scaleX: 1, opacity: 1 }}
                      animate={{ scaleX: [1, 1, 0, 0], opacity: [1, 1, 0, 0] }}
                      transition={{ duration: 2.5, times: [0, 0.15, 0.4, 1], repeat: Infinity, repeatDelay: 1.5, ease: "linear" }}
                    />
                  </div>
                )}
                {activeMove === 1 && (
                  <svg viewBox="0 0 300 150" className="w-full max-w-xl h-64 overflow-visible">
                    <defs>
                      <linearGradient id="three-gradient" x1="0" y1="0" x2="1" y2="0">
                    ...
                    <motion.path 
                      ...
                      animate={{ pathLength: [0, 1, 1, 0], strokeWidth: [8, 1, 1, 8] }}
                      transition={{ duration: 3, times: [0, 0.4, 0.8, 1], repeat: Infinity, repeatDelay: 1.5, ease: "easeOut" }}
                      style={{ filter: "drop-shadow(0px 0px 10px #D15600)" }}
                    />
                    <motion.path 
                      d="M 280 140 L 300 140 M 275 145 L 295 160 M 305 145 L 285 160"
                      stroke="#D15600" strokeWidth="2" fill="none"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: [0, 0, 1, 0] }}
                      transition={{ duration: 3, times: [0, 0.4, 0.5, 1], repeat: Infinity, repeatDelay: 1.5 }}
                    />
                  </svg>
                )}
                {activeMove === 2 && (
                  <svg viewBox="0 0 300 150" className="w-full max-w-lg h-64 overflow-visible">
                    <defs>
                      <linearGradient id="dribble-gradient" x1="0" y1="0" x2="1" y2="0">
                    ...
                    <motion.polyline 
                      ...
                      transition={{ duration: 2.5, times: [0, 0.3, 0.8, 1], repeat: Infinity, repeatDelay: 1.5, ease: "anticipate" }}
                      style={{ filter: "drop-shadow(0px 0px 8px rgba(0,119,255,0.4))" }}
                    />
                    <motion.circle cx="100" cy="20" r="6" fill="#0077FF" animate={{ scale: [1, 2, 1] }} transition={{ duration: 2.5, repeat: Infinity, repeatDelay: 1.5, times: [0, 0.2, 1] }} />
                    <motion.circle cx="200" cy="120" r="6" fill="#3F2B56" animate={{ scale: [1, 2, 1] }} transition={{ duration: 2.5, repeat: Infinity, repeatDelay: 1.5, times: [0, 0.4, 1] }} />
                  </svg>
                )}
                {activeMove === 3 && (
                  <svg viewBox="0 0 300 200" className="w-full max-w-md h-64 overflow-visible">
                    <motion.path 
                      d="M 20 180 Q 80 80 150 50" 
                      fill="none" stroke="#d4af37" strokeWidth="4"
                      initial={{ pathLength: 0 }}
                      animate={{ pathLength: [0, 1, 1, 0] }}
                      transition={{ duration: 2.5, times: [0, 0.3, 0.8, 1], repeat: Infinity, repeatDelay: 1.5, ease: "circOut" }}
                      style={{ filter: "drop-shadow(0px 0px 8px rgba(212,175,55,0.4))" }}
                    />
                    <motion.path 
                      d="M 280 180 Q 220 20 150 50" 
                      fill="none" stroke="#8A1538" strokeWidth="4"
                      initial={{ pathLength: 0 }}
                      animate={{ pathLength: [0, 1, 1, 0] }}
                      transition={{ duration: 2.5, times: [0, 0.3, 0.8, 1], repeat: Infinity, repeatDelay: 1.5, ease: "circOut" }}
                      style={{ filter: "drop-shadow(0px 0px 8px rgba(138,21,56,0.4))" }}
                    />
                    <motion.circle 
                      cx="150" cy="50" r="30" fill="none" stroke="#FF7B00" strokeWidth="6"
                      initial={{ scale: 0, opacity: 0 }}
                      animate={{ scale: [0, 0, 1, 1.2, 0], opacity: [0, 0, 1, 0, 0] }}
                      transition={{ duration: 2.5, times: [0, 0.28, 0.35, 0.8, 1], repeat: Infinity, repeatDelay: 1.5, ease: "easeOut" }}
      ...
      <div className="w-full bg-[#020202] border-t border-[#C0C0C0]/20 z-20">
         <div className="flex w-full overflow-x-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {moves.map((move, i) => (
              <button 
                key={i}
                onClick={() => { setActiveMove(i); if(soundEnabled) playAudio('beep', true); }}
              ...
              >
                 ...
                 <div className="w-8 h-8 mb-2 flex items-center justify-center">
                    {i === 0 && <div className="w-1 h-6 bg-current rotate-90 relative"><div className="absolute w-1 h-6 bg-current -rotate-90" /></div>}
                    {i === 1 && <svg className="w-6 h-6 stroke-current fill-none overflow-visible"><path d="M 0 20 Q 12 0 24 20" strokeWidth={2}/></svg>}
                    {i === 2 && <svg className="w-6 h-6 stroke-current fill-none overflow-visible"><polyline points="0,20 12,0 24,20" strokeWidth={2}/></svg>}
                    {i === 3 && <div className="w-5 h-5 border-2 border-current rounded-full" />}
                 </div>
                 <span className="font-mono text-[9px] md:text-[10px] uppercase font-bold tracking-widest px-2 text-center">{move.title}</span>
              </button>
            ))}
         </div>
         <div className="flex justify-between items-center px-4 md:px-8 py-3 bg-[#4C392D] border-t border-[#C0C0C0]/20 font-mono text-[8px] md:text-[10px] uppercase text-[#C0C0C0]/60 tracking-widest">
           ...
           <span className="text-[#d4af37] border border-[#d4af37]/30 px-2 py-0.5">Real Game Moments</span>
         </div>
      </div>
      ...
      <div className="w-full relative bg-[#020202] border-t-4 border-[#E4DCCF] mt-12 md:mt-24">
         ...
         <div className="max-w-5xl mx-auto px-8 py-24 md:py-40 text-center relative z-10 flex flex-col items-center justify-center">
            <h4 className="font-mono text-[10px] md:text-xs uppercase tracking-[0.2em] text-[#C0C0C0]/50 mb-12 border-b border-[#C0C0C0]/20 pb-4 inline-block">Movement As Structure</h4>
            
            <p className="font-headline text-2xl md:text-4xl font-black uppercase text-white leading-snug tracking-tight">
               In Wembanyama's actions, I saw the ultimate reference for interface animation:<br/>
               <span className="text-[#C0C0C0] mt-4 block">Not fancy curves, but intentional mechanics.</span><br/>
               <span className="text-[#d4af37] block mt-8 text-xl md:text-3xl leading-relaxed">Every burst, every pause, every connection is a profound exercise<br/> in how structure is perceived.</span>
            </p>
         </div>
      </div>
...
function TheSpursTime({ soundEnabled }: { soundEnabled: boolean }) {
  ...
  return (
    <div className="min-h-screen w-full relative flex flex-col items-center bg-gradient-to-b from-[#020202] to-[#1E152A] overflow-hidden font-sans border-b-4 border-[#C0C0C0]">
      ...
      {/* Hall Identity */}
      <div className="absolute top-12 left-8 md:top-24 md:left-24 z-20 pointer-events-none">
        <h2 className="text-[10px] md:text-xs font-mono uppercase tracking-[0.3em] text-[#C0C0C0]/50 mb-2">Hall 4</h2>
        <h3 className="text-2xl md:text-4xl font-headline font-black text-[#E4DCCF] tracking-widest uppercase">The Spurs Time</h3>
        <p className="font-serif italic text-sm text-[#d4af37] mt-2 drop-shadow-[0_0_5px_rgba(212,175,55,0.5)]">Champions are moments, culture is time itself.</p>
      </div>
      ...
      <div className="flex-1 w-full flex flex-col md:flex-row items-center justify-center relative mt-32 md:mt-0 z-10 min-h-[60vh] max-w-7xl mx-auto px-4">
         ...
         <div className="w-[300px] h-[300px] md:w-[600px] md:h-[600px] relative flex items-center justify-center shrink-0">
            ...
            <div className="absolute inset-0 m-auto w-3/4 h-3/4 flex flex-col items-center justify-center text-center z-10 pointer-events-none">
               <h4 className="font-serif italic text-xl md:text-3xl text-[#C0C0C0] mb-2 leading-relaxed mix-blend-screen">
                 He is not the heir;<br/>
                 <span className="text-white font-black uppercase text-2xl md:text-4xl not-italic mt-2 block tracking-tighter">He is the starting point<br/>for the next scale.</span>
               </h4>
                 ...
                 return (
                   ...
                   >
                     ...
                     <motion.div 
                        ...
                        onHoverStart={() => { setActiveEra(era.id); if(soundEnabled) playAudio('beep', true); }}
                     ...
                     <AnimatePresence>
                       {isActive && (
                          <motion.div 
                            ...
                            style={{ transform: `rotate(${-ringRotation - era.angle}deg)` }} // keep upright
                          >
                             <div className="relative aspect-square overflow-hidden mb-2">
                               <img src={era.img} alt={era.title} className="w-full h-full object-cover grayscale contrast-[1.2] opacity-80 mix-blend-luminosity" />
                             ...
                             <div className="font-mono text-[9px] md:text-[10px] text-[#d4af37] tracking-widest uppercase mb-1">{era.year}</div>
                             <div className="font-bold text-[#E4DCCF] text-xs uppercase mb-1 leading-tight">{era.title}</div>
                             <div className="text-[10px] text-[#C0C0C0]/70 font-mono">{era.desc}</div>
                          </motion.div>
                       )}
                     </AnimatePresence>
                   </div>
            ...
            <div className="absolute w-[120%] h-[120%] rounded-full border-t border-r border-transparent z-0 pointer-events-none flex items-start justify-end pr-[10%] pt-[10%]">
               ...
               >
                  <svg className="absolute inset-0 w-full h-full overflow-visible" viewBox="0 0 100 100">
                    <defs>
                      <linearGradient id="wemby-era-gradient" x1="0" y1="0" x2="1" y2="1">
                        <stop offset="0%" stopColor="#0077FF"/>
                    ...
                    <motion.path 
                      ...
                      fill="none" stroke="url(#wemby-era-gradient)" strokeWidth="2" strokeDasharray="2 2"
                      initial={{ pathLength: 0 }}
                  ...
                  {/* Particles */}
                  <motion.div className="w-1.5 h-1.5 bg-[#FF7B00] absolute top-0 right-0 shadow-[0_0_15px_#FF7B00]" animate={{ y: [-20, -50], opacity: [1, 0], scale: [1, 2] }} transition={{ duration: 2, repeat: Infinity }} />
               </motion.div>
               
               <div 
                 className="absolute top-0 right-0 md:-right-12 translate-x-1/2 -translate-y-1/2 group cursor-pointer pointer-events-auto"
                 onMouseEnter={() => { if(soundEnabled) playAudio('swoosh', true); }}
               ...
               >
                  <div className="w-16 h-16 md:w-24 md:h-24 rounded-full border-2 border-[#0077FF] bg-[#020202] flex items-center justify-center shadow-[0_0_25px_rgba(0,119,255,0.4)] p-1 transition-transform group-hover:scale-110 group-hover:border-[#8A1538] group-hover:shadow-[0_0_30px_rgba(138,21,56,0.6)]">
                    <img src="https://images.unsplash.com/photo-1546519638-68e109498bdc?auto=format&fit=crop&q=80&w=200" alt="Wemby Era" className="w-full h-full rounded-full object-cover grayscale contrast-[1.5] mix-blend-luminosity" />
                  </div>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 text-center pointer-events-none">
                    <span className="font-mono text-[9px] md:text-[10px] text-[#0077FF] font-bold tracking-widest uppercase bg-[#020202] px-2 py-1 border border-[#0077FF]/50 shadow-[0_0_10px_rgba(0,119,255,0.2)] whitespace-nowrap">NOW</span>
                  </div>
               </div>
            </div>
         ...
         <AnimatePresence>
            {isWembyPanelOpen && (
               ...
               >
                 <button onClick={() => setIsWembyPanelOpen(false)} className="absolute top-4 right-4 text-[#C0C0C0] hover:text-white"><VolumeX className="w-4 h-4 opacity-0" /><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 6L6 18M6 6l12 12"/></svg></button>
                 <h4 className="font-mono text-[10px] uppercase tracking-widest text-[#0077FF] mb-2 drop-shadow-[0_0_5px_rgba(0,119,255,0.5)]">Future Structure</h4>
                 <h3 className="text-xl font-black text-[#E4DCCF] uppercase mb-4 tracking-tight">The Next Scale</h3>
                 <p className="font-mono text-xs text-[#C0C0C0]/80 leading-relaxed mb-6">
                   Wembanyama is a new architectural principle. The historical structure of the Spurs provides the foundation, but the future spiral must remain unclosed.
                   <br/><br/>
                   This brings us back to design: a perfect system is never finished. It only provides a better starting point for the next impossibility.
                 </p>
      ...
      <div className="w-full bg-[#050505] border-t border-[#C0C0C0]/10 mt-24">
         <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center p-8 md:p-16 gap-8 md:gap-16 relative">
            <div className="w-full md:w-1/2 h-64 md:h-[400px] relative border-4 border-[#3F2B56]/50 bg-[#1E152A] shadow-[0_0_30px_rgba(63,43,86,0.3)]">
               ...
               <img src="https://images.unsplash.com/photo-1519861531473-9200262188bf?auto=format&fit=crop&q=80&w=800" alt="Contemplation" className="w-full h-full object-cover grayscale opacity-80 mix-blend-luminosity" />
            </div>
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center">
               ...
               <div className="space-y-6 font-mono text-xs md:text-sm text-[#C0C0C0]/70 leading-relaxed pl-4 border-l-2 border-[#d4af37]">
                 <p>
                   The Spurs have never been a team, but a structural system that has lasted for thirty years.
                 </p>
                 <p>
                   Wembanyama is not here to copy the past;<br/>
  ...
  return (
    <div className="h-screen w-full relative flex flex-col md:flex-row overflow-hidden border-b-4 border-[#C0C0C0] bg-[#020202] font-sans">
       ...
       <div className="absolute top-12 left-8 md:top-24 md:left-24 z-20 pointer-events-none mix-blend-difference text-white">
        <h2 className="text-[10px] md:text-xs font-mono uppercase tracking-[0.3em] opacity-50 mb-2">Hall 5</h2>
        <h3 className="text-2xl md:text-4xl font-headline font-black tracking-widest uppercase">Silence & Noise</h3>
      </div>
        ...
        <div className="absolute inset-0 z-0 mix-blend-multiply">
          {[...Array(30)].map((_, i) => (
             <motion.div 
               ...
               transition={{ duration: balance ? 2 : Math.random() * 0.5 + 0.1, repeat: balance ? 0 : Infinity }}
             />
          ))}
        </div>
        <motion.div 
      ...
      <div 
        ...
        onMouseEnter={() => { setBalance(true); if(soundEnabled) playAudio('door', true); }}
      ...
      >
        <motion.div 
          ...
          animate={{ 
            ...
            boxShadow: balance ? '0 0 30px rgba(255,123,0,0.8)' : '0 0 0 rgba(255,123,0,0)'
          }}
          transition={{ duration: balance ? 0.5 : 2, repeat: balance ? 0 : Infinity }}
        />
        ...
        <AnimatePresence>
          {balance && (
            ...
            >
               ...
               <svg viewBox="0 0 100 200" className="w-32 h-64 md:w-48 md:h-96 mix-blend-screen overflow-visible">
                 <defs>
                   <linearGradient id="silhouette-gradient" x1="0" y1="0" x2="1" y2="1">
                 ...
                 <motion.path 
                   ...
                   fill="none" strokeWidth="4" strokeLinecap="square" strokeLinejoin="miter" stroke="url(#silhouette-gradient)"
                   initial={{ pathLength: 0 }}
                   animate={{ pathLength: 1 }}
                   transition={{ duration: 1.5, ease: "easeInOut" }}
                   style={{ filter: "drop-shadow(0 0 10px rgba(138,21,56,0.6))" }}
                 />
                 <motion.circle cx="50" cy="20" r="10" fill="none" stroke="#d4af37" strokeWidth="4" 
                   initial={{ scale: 0 }} 
...
function ThePureShape({ soundEnabled }: { soundEnabled: boolean }) {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-[#020202] via-[#3F2B56]/40 to-[#8A1538]/30 flex flex-col items-center justify-center p-8 relative overflow-hidden font-sans">
      ...
      {/* Hall Identity */}
      <div className="absolute top-12 left-8 md:top-24 md:left-24 z-20 pointer-events-none">
        <h2 className="text-[10px] md:text-xs font-mono uppercase tracking-[0.3em] text-[#C0C0C0]/50 mb-2">Final Chapter</h2>
        <h3 className="text-2xl md:text-4xl font-headline font-black text-white tracking-widest uppercase">The Pure Shape</h3>
        <p className="font-serif italic text-sm text-[#d4af37] mt-2">Not an end, but a new beginning.</p>
      </div>
      ...
      <div className="flex-1 w-full max-w-4xl flex flex-col items-center justify-center z-10 mt-32 md:mt-24">
         ...
         <div className="w-64 h-64 md:w-96 md:h-96 relative flex items-center justify-center mb-16 md:mb-24">
            <motion.svg 
               ...
               animate={{ filter: `drop-shadow(0 0 30px ${colors[shapeIndex].shadow})` }}
            ...
            >
               <motion.path
                 ...
                 animate={{ d: shapes[shapeIndex], stroke: colors[shapeIndex].main }}
               ...
               <motion.path
                 ...
                 strokeWidth="0.5"
                 strokeDasharray="2 2"
                 animate={{ d: shapes[shapeIndex], stroke: colors[shapeIndex].acc, rotate: 180, scale: 0.9 }}
                 transition={{ duration: 2, ease: "easeInOut", rotate: { duration: 20, repeat: Infinity, ease: "linear" } }}
         ...
         <div className="text-center max-w-2xl mb-16 md:mb-24">
            ...
            >
              Greatness is not to be seen,<br/>
              it is perceived.
            </motion.h4>
            ...
            >
              <span className="text-[#d4af37]">When you leave here,</span><br/>
              <span className="text-[#E4DCCF]">watch any game again,</span><br/>
              <span className="text-[#8A1538]">you will see these lines</span><br/>
              <span className="text-[#0077FF] font-bold">run on a real pitch.</span>
            </motion.p>
         </div>
         ...
         >
           <button 
             onClick={() => { if(soundEnabled) playAudio('swoosh', true); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
           ...
           <button 
             onClick={() => { if(soundEnabled) playAudio('beep', true); alert("Navigating to Data Layer..."); }}
         ...
         >
           This is not fandom.<br/>
           <span className="text-white/40 mt-2 block">This is architecture.</span>
         </motion.div>
