    ...
    >
      ...
      <motion.div 
        ...
        style={{
          ...
          WebkitMaskImage: 'radial-gradient(circle at center, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.15) 100%)',
          maskImage: 'radial-gradient(circle at center, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.15) 100%)'
        } as any}
      />
      ...
      <div 
        className="absolute inset-0 z-0 pointer-events-none"
        style={{
          background: 'radial-gradient(circle at center, transparent 40%, rgba(196, 162, 101, 0.12) 100%)'
        }}
      />
      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-5xl px-4 md:px-8 gap-y-24 md:gap-y-32">
          ...
          >
            <motion.div 
              ...
              style={{
                ...
                boxShadow: lineExpanded ? '0 0 15px rgba(212, 175, 55, 0.2)' : 'none'
              }}
              initial={{ scaleX: 0 }}
        ...
        >
          ...
          >
             {/* Artifact above text */}
            <div className="absolute z-0 hidden sm:block" style={{ top: '-0.3em', left: '-1em' }}>
              <motion.div
                initial={{ opacity: 0 }}
            ...
            >
              "The system is the gymnasium<br className="block md:hidden"/> of the product."
            </h2>
          </motion.div>
