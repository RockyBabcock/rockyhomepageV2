...
export default function BlogArticlePage() {
  ...
  return (
    ...
    >
      <Link to="/" className="inline-flex items-center gap-2 text-primary font-mono text-[10px] uppercase tracking-widest font-black mb-12 hover:-translate-x-1 transition-transform border-b-2 border-primary pb-1">
      ...
      <div className="border-t-[3px] border-ink pt-8 mt-16 flex justify-between items-center">
        <p className="font-mono text-xs text-ink font-black uppercase tracking-widest bg-yellow-300 border-[2px] border-ink px-4 py-2">End of Article</p>
      </div>
    </motion.div>
  );
}
