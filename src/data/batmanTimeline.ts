...
export const timelineData: TimelineEntry[] = [
  ...
  { 
    ...
    suitAnalysis: "First live-action suit. Very loose fitting, floppy ears, large utility belt.", 
    villain: "Dr. Daka",
  ...
  { 
    ...
    suitAnalysis: "Similar to the 1943 suit but with a slightly better fitting cowl.", 
    villain: "The Wizard",
    genre: "Action/Adventure",
  ...
  { 
    ...
    suitAnalysis: "Bright blue and grey spandex, drawn-on eyebrows on the cowl.", 
  ...
  { 
    ...
    suitAnalysis: "Spandex and drawn-on eyebrows. Utility belt features Shark Repellent Bat-Spray.", 
  ...
  { 
    ...
    crimeRating: 7, 
    quote: "I'm Batman.", 
    suitAnalysis: "Molded rubber muscle suit, unable to turn head. Iconic yellow oval emblem.", 
    villain: "The Joker",
    genre: "Gothic Superhero",
    trivia: "Michael Keaton's casting caused massive fan backlash initially.",
    comicComparison: "Heavily influenced by The Dark Knight Returns and The Killing Joke."
  },
  { 
    year: 1992, 
    ...
    suitAnalysis: "More streamlined, art-deco inspired armor. Cowl still restricts movement.", 
    villain: "Penguin, Catwoman, Max Shreck",
    genre: "Gothic Fairy Tale",
    trivia: "McDonald's canceled their Happy Meal tie-in because the film was too dark.",
    comicComparison: "Burton's original vision took precedence over comic accuracy."
  },
  { 
    year: 1995, 
    ...
    suitAnalysis: "Introduction of the infamous 'Bat-nipples' and anatomical sculpting. Sonar suit later.", 
    villain: "Two-Face, The Riddler",
    genre: "Neon Action",
    trivia: "Val Kilmer took the role without reading the script or knowing who the director was.",
    comicComparison: "A shift back towards the colorful, campy tone of the Silver Age."
  },
  { 
    year: 1997, 
    title: "Batman & Robin", 
    ...
    suitAnalysis: "Silver-accented 'ice' armor for the finale. More prominent anatomical details.", 
    villain: "Mr. Freeze, Poison Ivy, Bane",
    genre: "Camp/Action",
    trivia: "George Clooney has famously apologized for 'destroying' the franchise.",
  ...
  { 
    ...
    suitAnalysis: "Classic grey and blue/black with the yellow oval. Bold, angular Bruce Timm design.", 
    villain: "The Phantasm, The Joker",
    genre: "Animated Noir",
    trivia: "Originally planned as a direct-to-video release before getting a theatrical run.",
    comicComparison: "Considered by many the truest adaptation of the comic book mythos."
  },
  { 
    year: 1998, 
    ...
    trivia: "Release was delayed due to the poor reception of the live-action Batman & Robin.",
    comicComparison: "Continues the tragic arc of Mr. Freeze established in 'Heart of Ice'."
  },
  { 
    year: 1999, 
    ...
    crimeRating: 8, 
    quote: "Schway.", 
    suitAnalysis: "High-tech, sleek black suit with a red bat emblem. Full face covering.", 
    villain: "Blight, Inque, Derek Powers",
    genre: "Cyberpunk/Sci-Fi",
    trivia: "Created because executives wanted a 'teenage Batman'.",
    comicComparison: "Original concept, later integrated into the main DC comic continuity."
  },
  { 
    year: 2000, 
  ...
  { 
    ...
    suitAnalysis: "Shorter ears, wider chest emblem, more stylized and angular.", 
    villain: "Various",
    genre: "Animated Action",
    trivia: "Features completely redesigned, unconventional takes on classic villains.",
  ...
  },
  {
    ...
    suitAnalysis: "Classic Silver Age blue and grey with a very blocky, heroic build.",
    villain: "Various",
  ...
  },
  {
    ...
    genre: "Animated Thriller",
    trivia: "Adapts the 'A Death in the Family' and 'Under the Hood' storylines.",
  ...
  },
  {
    ...
    crimeRating: 10,
    quote: "This isn't a mudhole... It's an operating table. And I'm the surgeon.",
    suitAnalysis: "Massive, bulky frame. Short ears, large bat symbol. Later uses heavy power armor.",
  ...
  },
  {
    ...
    comicComparison: "Adapts Alan Moore's famous graphic novel, adding a controversial prologue."
  },
  {
    year: 2017,
    ...
    comicComparison: "A parody that deeply understands the core of the character."
  },
  ...
  { 
    ...
    suitAnalysis: "Nomex survival suit, memory cloth cape. First truly tactical approach.", 
    villain: "Ra's al Ghul, Scarecrow",
    genre: "Action/Thriller",
    trivia: "Christian Bale gained 100 lbs of muscle after The Machinist for the role.",
  ...
  { 
    ...
    suitAnalysis: "Titanium-dipped tri-weave armor, separated cowl allowing head movement. Sonar lenses.", 
    villain: "The Joker, Two-Face",
    genre: "Crime Thriller",
    trivia: "First major motion picture to be partially shot with IMAX cameras.",
  ...
  { 
    ...
    suitAnalysis: "Same suit as TDK, but shows wear and tear. Braces added to support his knee.", 
    villain: "Bane, Talia al Ghul",
    genre: "Epic Action/Thriller",
    trivia: "Tom Hardy wore three-inch lifts to appear taller than Christian Bale.",
    comicComparison: "Inspired by Knightfall, The Dark Knight Returns, and No Man's Land."
  },
  ...
  { 
    ...
    suitAnalysis: "Fabric-based suit over massive muscle padding. Short ears, huge bat symbol. Heavy mech suit for the fight.", 
    villain: "Lex Luthor, Doomsday",
    genre: "Superhero Epic",
    trivia: "Ben Affleck's Batman is older, more cynical, and operates out of a glass house rather than Wayne Manor.",
    comicComparison: "Visually identical to Frank Miller's The Dark Knight Returns."
  },
  { 
    year: 2016, 
    title: "Suicide Squad", 
    ...
    silhouette: "bulky-brawler", 
    crimeRating: 9, 
    quote: "I'm not gonna kill ya. I'm just gonna hurt ya... really, really bad.", 
    suitAnalysis: "Same suit as BvS, seen briefly in flashbacks.", 
    villain: "Enchantress, The Joker",
    genre: "Action/Anti-hero",
    trivia: "Batman appears only in brief cameos capturing Deadshot and Harley Quinn.",
  ...
  { 
    ...
    trivia: "The film underwent massive reshoots, changing Batman's tone significantly.",
  ...
  { 
    ...
    suitAnalysis: "Same tactical suit, but presented in a darker, more consistent visual tone.", 
  ...
  { 
    ...
    suitAnalysis: "Features both Affleck's blue/grey suit and Keaton's upgraded modern armor.", 
  ...
  { 
    ...
    crimeRating: 9, 
    quote: "I'm vengeance.", 
    suitAnalysis: "Hand-crafted tactical gear, chest emblem acts as a tactical knife. Heavy collar.", 
    ...
    comicComparison: "Inspired by Batman: Ego, Year One, and The Long Halloween."
  },
  { 
    year: 2024, 
    ...
    suitAnalysis: "Batman's presence is felt more than seen in the aftermath of the flood.", 
